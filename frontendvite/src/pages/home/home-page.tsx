...
export default function HomePage() {
  ...
  // Add these lines
  const { isVisible: showTooltip, showTooltip: displayTooltip, showAllTooltips: displayAllTooltips } = useTooltip()
  const { isVisible: showFinanceTipTooltip, showTooltip: displayFinanceTipTooltip } = useTooltip({ isGlobal: true })
  ...
  return (
    <PageLayout onAddButtonClick={handleAddButtonClick}>
      ...
      <div className="page-header-container scale-80 transform-origin-top">
        <PageHeader title="Overview" initialDate={currentDate} onMonthChange={setCurrentDate} />
      </div>
      ...
      <main className="flex-1 px-4 pb-6 mt-4 flex flex-col gap-4 w-full flex-grow overflow-hidden">
          ...
          {selectedView !== "extended" && (
            ...
            >
              ...
              <div className="w-full flex justify-center">
                <p className="text-sm font-normal text-gray-500 text-center">Neue Ausgabe hinzufügen</p>
              </div>
        ...
        >
          <div className="flex justify-between items-center mb-2">
            <h3 className="text-xl font-semibold text-blue-600">Finanz-Tipp des Tages</h3>
          ...
          <p className="text-base font-medium text-gray-700">
            Regelmäßige kleine Einsparungen können sich über Zeit zu beträchtlichen Summen addieren. Versuchen Sie,
            täglich auf einen kleinen Luxus zu verzichten und sparen Sie den Betrag.
          </p>
          ...
          {showFinanceTipTooltip && (
            <div className="absolute top-0 right-12 w-48 p-2 bg-white text-gray-800 rounded-lg shadow-lg text-sm font-normal z-20">
              <p>Diese Tipps werden täglich aktualisiert und helfen Ihnen, Ihre Finanzen besser zu verwalten.</p>
