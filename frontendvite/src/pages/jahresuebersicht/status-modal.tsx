      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-md w-full max-w-sm overflow-hidden">
          ...
          <div className="p-4">
            ...
            {/* Klärungshinweis dynamisch */}
            {month.status === "needs-clarification" && month.clarificationReactionsList.length > 0 && (
                <div className="mt-4 p-3 bg-amber-50 text-amber-700 rounded-md border border-amber-200">
                  ...
                  <p className="text-sm">
                    {month.clarificationReactionsList.some(r => r.status === "Rejected")
                        ? "Mindestens eine Ablehnung liegt vor."
                        : "Es gibt Rückmeldungen zu bestimmten Ausgaben, die noch nicht bestätigt wurden."}
                  </p>
                </div>
            )}
          </div>
