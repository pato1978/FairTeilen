            ...
            <div className="flex-1 px-4 pb-6 mt-4 flex flex-col overflow-hidden">
                <div className="bg-white shadow-md rounded-lg p-4 flex-1 flex flex-col overflow-hidden mb-4">
                    ...
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <button
                            onClick={() =>
                                setViewType(viewType === 'total' ? 'categories' : 'total')
                            }
                    ...
                    >
                        <div>
                            ...
                            <div
                                className={`text-xl font-bold ${trend.isPositive ? 'text-red-600' : 'text-green-600'}`}
                            >
                                {trend.isPositive ? '+' : '-'}
                                {trend.value}%
                            </div>
                        ...
                        <div
                            className={`p-2 rounded-full ${trend.isPositive ? 'bg-red-100' : 'bg-green-100'}`}
                        >
                            {trend.isPositive ? (
